...
var ExtraNonceCounter = function () {
    this.next = function () {
      // 3 byte extranonce. 1 in 16M chance of collision.
      return(crypto.randomBytes(3).toString('hex'));

      // var extraNonce = Buffer.alloc(3);
      // var extraNonce = new Buffer(3);
      // extraNonce.writeUIntBE(counter++, 2, 2);
      // extraNonce.writeUIntBE(crypto.randomBytes(2).readUIntLE(0, 2), 0, 2);
...
var JobManager = module.exports = function JobManager(options) {
    ...
    this.processShare = function (miner_given_jobId, previousDifficulty, difficulty, miner_given_nonce, ipAddress, port, workerName, miner_given_header, miner_given_mixhash, callback_parent) {
        ...
        console.log("target_hex             = "+job.target_hex);
        ...
        // var nonce_decimal = parseInt(BigInt(miner_given_nonce,16));
